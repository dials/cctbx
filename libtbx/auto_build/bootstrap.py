...
# wget https://raw.githubusercontent.com/dials/cctbx/dials-2.0/libtbx/auto_build/bootstrap.py
# or
# curl https://raw.githubusercontent.com/dials/cctbx/dials-2.0/libtbx/auto_build/bootstrap.py > bootstrap.py
...
class ccp4io_module(SourceModule):
  module = 'ccp4io'
  anonymous = ['git', '-b dials-2.0', 'https://github.com/dials/%s/archive/dials-2.0.zip' % module ]
...
class cctbx_module(SourceModule):
  ...
  anonymous = ['git', '-b dials-2.0',
               'git@github.com:dials/cctbx.git',
               'https://github.com/dials/cctbx.git',
               'https://github.com/dials/cctbx/archive/dials-2.0.zip']
...
class dials_module(SourceModule):
  ...
  anonymous = ['git', '-b dials-2.0',
               ...
               'https://github.com/dials/dials/archive/dials-2.0.zip']

class dxtbx_module(SourceModule):
  module = 'dxtbx'
  anonymous = ['git', '-b dials-2.0',
               'git@github.com:dials/dxtbx.git',
               'https://github.com/dials/dxtbx.git',
               'https://github.com/dials/dxtbx/archive/dials-2.0.zip']
...
class msgpack_module(SourceModule):
  module = 'msgpack'
  anonymous = ['curl', "https://gitcdn.link/repo/dials/dependencies/dials-2.0/msgpack-3.1.1.tar.gz"]
...
class xia2_module(SourceModule):
  ...
  anonymous = ['git', '-b dials-2.0',
               ...
               'https://github.com/xia2/xia2/archive/dials-2.0.zip']
