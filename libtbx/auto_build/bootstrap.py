...
# wget https://raw.githubusercontent.com/dials/cctbx/dials-1.14/libtbx/auto_build/bootstrap.py
# or
# curl https://raw.githubusercontent.com/dials/cctbx/dials-1.14/libtbx/auto_build/bootstrap.py > bootstrap.py
...
class ccp4io_module(SourceModule):
  module = 'ccp4io'
  anonymous = ['git', '-b dials-1.14', 'https://github.com/dials/%s/archive/dials-1.14.zip' % module ]
...
class dials_module(SourceModule):
  ...
  anonymous = ['git', '-b dials-1.14',
               ...
               'https://github.com/dials/dials/archive/dials-1.14.zip']
...
class xia2_module(SourceModule):
  ...
  anonymous = ['git', '-b dials-1.14',
               ...
               'https://github.com/xia2/xia2/archive/dials-1.14.zip']
