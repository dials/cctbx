...
BASE_CCI_PKG_URL = "https://cdn.rawgit.com/dials/dependencies/dials-1.10/"
...
DEPENDENCIES_BASE = "https://cdn.rawgit.com/dials/dependencies/dials-1.10/"
...
# HDF5
BASE_HDF5_PKG_URL = "https://cdn.rawgit.com/dials/dependencies/dials-1.10"
...
git_repositories = {
  ...
  "hdf5_lz4": [#'git@github.com:dectris/HDF5Plugin.git',
               ...
               'https://github.com/cctbx/HDF5Plugin/archive/dials-1.10.zip'],
  "bitshuffle": [#'git@github.com:kiyo-masui/bitshuffle.git',
                 #'https://github.com/kiyo-masui/bitshuffle.git',
                 'https://github.com/cctbx/bitshuffle/archive/dials-1.10.zip'],
}
