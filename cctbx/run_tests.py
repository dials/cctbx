...
tst_list = [
  ...
  ["$D/development/run_shelx76.py", "P31"],
   ...
   "$D/maptbx/tst_bcr.py",
   "$D/maptbx/bcr/tst_example.py",
   "$D/maptbx/bcr/tst_qmap_02.py",
   "$D/maptbx/bcr/tst_table.py",
   "$D/maptbx/bcr/tst_two_atoms.py",
   "$D/maptbx/bcr/tst_vrm.py",
   "$D/maptbx/bcr/tst_vrm2.py",
   #
